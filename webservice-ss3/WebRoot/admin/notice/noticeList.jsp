...
<script type="text/javascript" src="<%=basePath%>js/page.js"></script>
  ...
  <body>
    <form name="form" id="form" method="post" action="admin/notice/noticeSearch.do">
        ...
        <tr>
          <td height="62" background="images/nav04.gif">
		    ...
		    <tr>
			  ...
			  <td width="538">公告内容：
				<input name="logTagName" value="<s:property value='content'/>" type="text" size="12"/>
				<input name="Submit4" type="submit" class="right-button02" value="查 询" />
				<a href="admin/notice/gotoAddNotice.do">添加公告</a>
			  </td>
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
				...
				<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
				 <tr class="CTitle" >
                    	<td height="22" colspan="7" align="center" style="font-size:16px">公告列表</td>
                  </tr>
                  <tr bgcolor="#EEEEEE">
                  ...
                  <tr bgcolor="#FFFFFF">
				    <td height="20"><input type="checkbox" class="delid" delId="<s:property value="#notice.id"/>" name="delid"/></td>
                    <td ><s:property value="#notice.fromusername"/></td>
					<td><s:property value="#notice.msgContent"/></td>
					<td><s:property value="#notice.msgStatus"/></td>
					<td><s:property value="#notice.triggerTime"/></td>
