          ...
          <td height="62" background="images/nav04.gif">
		    ...
		    <tr>
			  ...
			  <td width="538">资源名：
				...
				<a href="admin/res/gotoAdd.do">添加资源</a>
			  </td>
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
				...
				<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
				 <tr class="CTitle" >
                    	<td height="22" colspan="7" align="center" style="font-size:16px">资源列表</td>
                  </tr>
                  <tr bgcolor="#EEEEEE">
                  ...
                  <s:iterator value="myResourcesList" id="res">
                  <tr bgcolor="#FFFFFF">
				    <td height="20"><input type="checkbox" class="delid" delId="<s:property value="#res.id"/>" name="delid"/></td>
                    <td ><s:property value="#res.resourceName"/></td>
					<td><s:property value="#res.url"/></td>
