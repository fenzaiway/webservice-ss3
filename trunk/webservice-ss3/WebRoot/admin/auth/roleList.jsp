          ...
          <td height="62" background="images/nav04.gif">
		    ...
		    <tr>
			  ...
			  <td width="538">角色名：
				...
				<a href="admin/role/gotoAddRole.do">添加角色</a>
			  </td>
              ...
              <tr>
				...
				<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
				 <tr class="CTitle" >
                  ...
                  <s:iterator value="myRolesList" id="role">
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td><a href="admin/role/gotoEdit.do?roleid=<s:property value="#role.id"/>">编辑|</a><a href="listrenwumingxi.htm">查看|</a>
